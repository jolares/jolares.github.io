...
@Component({
  ...
  template: `
    ...
    <mat-drawer-container class="mat-drawer-container" autosize>
      <mat-drawer #drawer class="sidenav-drawer-container" mode="push">

        <button type="button" mat-button class="close-sidenav-button"
          aria-label="close side navigation drawer"
          (click)="drawer.toggle()"
        >
          <mat-icon mat-icon aria-hidden="true">close</mat-icon>
        </button>

        <nav>
          <a routerLink="home">Home</a>
          <a routerLink="quote-remixer">Quote Remixer</a>
        </nav>
      </mat-drawer>

      <mat-drawer-content class="sidenav-content-container">
        <mat-toolbar role="banner" class="top-toolbar">
          <button type="button" mat-button
            aria-label="open side navigation drawer"
            (click)="drawer.toggle()"
          >
            <mat-icon mat-icon aria-hidden="true">menu</mat-icon>
          </button>
          <span>Welcome</span>
    ...
    <main class="content">
        ...
        <div class="terminal">
          ...
          <button mat-icon-button class="terminal-copy-button">
    ...
    <footer class="container">
      <p>Thank you for stopping by -- Jo</p>
    </footer>
    <!--
